...
See "Test.QuickCheck.Light.Function" for generating random shrinkable,
showable functions used for testing higher-order functions and
"Test.QuickCheck.Light.Monadic" for testing impure or monadic code
